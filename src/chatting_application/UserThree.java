...
import chatting_application.auth.SignIn;
...
public class UserThree implements ActionListener, Runnable {
    ...
    static UserEntityModel userEntityModel;
    ...
    Socket socket;
//    String name = userEntityModel.fullName;

    public UserThree(UserEntityModel userEntityModel) {
        UserThree.userEntityModel = userEntityModel;
        f.setLayout(null);

        JPanel p1 = new JPanel();
        p1.setBackground(new Color(81, 45, 168));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/" + userEntityModel.username + ".png"));
        ...
        JLabel status = new JLabel("Kawser, Nadia, Anonymous-1");
        ...
        send.setBackground(new Color(81, 45, 168));
...
//                showImage(imageData);
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            String out = "<html><p><span style='color: #4B0082; font-weight: bold;'>" + userEntityModel.fullName + "</span></p><p>" + text.getText() + "</p></html>";
        ...
        try {
            ...
            while ((msg = reader.readLine()) != null) {
                if (msg.startsWith("IMAGE::")) {
                    ...
                    if (!msg.contains(userEntityModel.fullName)) {
